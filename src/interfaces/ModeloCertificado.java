...
public class ModeloCertificado extends javax.swing.JDialog {
    ...
    {         
       ...
       try {
            ...
            Files.deleteIfExists(Paths.get(diretorio + "\\certificado.png"));
            Files.copy(Paths.get(caminho_modelo), Paths.get(diretorio + "\\certificado.png"));
            return true;
    ...
    private void initComponents() {
        ...
        nomeOrientador.setText("Imagem modelo certificado");
        getContentPane().add(nomeOrientador);
        nomeOrientador.setBounds(50, 40, 230, 20);
